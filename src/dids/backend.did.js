export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'getTotalKickAmount' : IDL.Func([], [IDL.Nat], ['query']),
    'getTotalKissAmount' : IDL.Func([], [IDL.Nat], ['query']),
    'getTotalUserAmount' : IDL.Func([], [IDL.Nat], ['query']),
    'getUserTwitterPicURL' : IDL.Func(
        [IDL.Text],
        [IDL.Opt(IDL.Text)],
        ['query'],
      ),
    'get_DAY_CLICK_AMOUNT' : IDL.Func([], [IDL.Nat], ['query']),
